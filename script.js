alert("Choose a number between 1 to 20 inclusive."); //rules of the game
...
function checkNumber() {
  ...
  if (luckyNumber < userNumber) {
    ...
    main.style.backgroundColor = '#FF1818';
    header.style.backgroundColor = '#890F0D';
    if(scoreNumber==0){
...
if (confirm("Do you want to restart?") == true) {
  ...
  if (luckyNumber == userNumber) {
    ...
    main.style.backgroundColor = '#00C897';
    header.style.backgroundColor = '#019267';
